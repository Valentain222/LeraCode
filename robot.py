...
def motion_programm(robot, step):
    match (step):
        ...
        case(1):
            robot.move("Robot1_1", 650, 260, 250, 0, 0) #A point
            return True

        case(2):
            robot.move("Robot1_1", 650, 260, 95, 0, 0) #A point
            return True
        
        case(3):
            robot.move("Robot1_1", 650, 260, 95, 0, 1) #A point
            return True

        case(4):
            robot.move("Robot1_1", 650, 260, 250, 0, 1) #A point
            return True

        case(5):
            robot.move("Robot1_1", 670, -511, 311.5, 0, 1) #A point
            return True

        case(6):
            robot.move("Robot1_1", 670, -511, 311.5, 45, 1) #A point
            return True

        case(7):
            time.sleep(5)
            robot.move("Robot1_1", 550, -300, 250, 0, 1) #B point
            return True

        case(8):
            robot.move("Robot1_1", 550, -300, 95, 0, 1) #B point
            return True
        ...
        case(10):
            robot.move("Robot1_1", 550, -300, 95, 0, 0) #B point
            return True

        case(11):
            robot.move("Robot1_1", 550, -300, 250, 0, 0) #B point
            return True

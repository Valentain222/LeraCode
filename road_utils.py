...
def detect_return_road(wrapped: np.ndarray, left_side_amount, right_side_amount, check_points=[0.3, 0.5, 0.9],
                       show=False, draw_on_input=False):
    h, w = wrapped.shape[:2]
    mid_w = w // 2
...
def cross_center_path_v4_2(bin, pixel_offset=0, line_amount_percent=0.1, bottom_offset_percent=0.3,
